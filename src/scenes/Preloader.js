...
export default class Preloader extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(400, 500, 'burger')
        this.add.image(400, 500, 'croissant')
        this.add.image(400, 500, 'donutSprinkles')
        this.add.image(400, 500, 'sushiSalmon')
        this.add.image(400, 500, 'taco')
